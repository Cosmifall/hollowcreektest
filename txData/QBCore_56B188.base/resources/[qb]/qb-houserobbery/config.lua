...
Config.ChanceToBreakLockPick = 0         -- chance in percent to break a normal lockpick if failed
Config.ChanceToBreakAdvancedLockPick = 0 -- chance in percent to break a advanced lockpick if failed
Config.ChanceToAlertPolice = 0           -- chance in percent to call the police if a house robbery is in progress
