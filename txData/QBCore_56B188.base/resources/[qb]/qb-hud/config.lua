...
Config.StressChance = 0.03         -- Default: 10% -- Percentage Stress Chance When Shooting (0-1)
...
Config.MinimumSpeed = 1000         -- Going Over This Speed While Buckled Will Cause Stress
