...
QBWeed.Progress = { -- How much progress will be added to a healthy plant every GrowthTick
    min = 50,        -- Changing this will change growth time progression. Example 1 to 50 will give 50 progression in the 9.6 min cycle.
    max = 51,        -- See above, make sure max is more then min.
}

QBWeed.ShowStages = true -- Show the stages of the plants
QBWeed.GrowthTick = .25  -- Amount of time (in mins) to increase plant growth & update health / nutrition (every second tick)
