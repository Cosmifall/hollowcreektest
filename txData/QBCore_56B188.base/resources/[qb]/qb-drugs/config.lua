Config = {
    ...
    PoliceCallChance = 15,                                 --in percentage (if 99, theres the 99% to call the police)
    ...
    DeliveryRepLoss = 0,        -- amount of rep lost if delivery wrong or late
    PoliceDeliveryModifier = 2, -- amount to multiply active cop count by
    WrongAmountFee = 1,         -- divide the payout by this value for wrong delivery amount
    OverdueDeliveryFee = 1,     -- divide the payout by this value for overdue delivery
